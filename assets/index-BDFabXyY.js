...
aut aut aut maxime quia temporibus ut omnis`}],Nc=[{id:1,name:"Leanne Graham",username:"Bret",email:"Sincere@april.biz"},{id:2,name:"Ervin Howell",username:"Antonette",email:"Shanna@melissa.tv"},{id:3,name:"Clementine Bauch",username:"Samantha",email:"Nathan@yesenia.net"},{id:4,name:"Patricia Lebsack",username:"Karianne",email:"Julianne.OConner@kory.org"},{id:5,name:"Chelsey Dietrich",username:"Kamren",email:"Lucio_Hettinger@annie.ca"},{id:6,name:"Mrs. Dennis Schulist",username:"Leopoldo_Corkery",email:"Karley_Dach@jasper.info"},{id:7,name:"Kurtis Weissnat",username:"Elwyn.Skiles",email:"Telly.Hoeger@billy.biz"},{id:8,name:"Nicholas Runolfsdottir V",username:"Maxime_Nienow",email:"Sherwood@rosamond.me"},{id:9,name:"Glenna Reichert",username:"Delphine",email:"Chaim_McDermott@dana.io"},{id:10,name:"Clementina DuBuque",username:"Moriah.Stanton",email:"Rey.Padberg@karina.biz"}],Pc=({name:e,email:t,body:i})=>V.jsxs("div",{className:"CommentInfo",children:[V.jsx("p",{className:"CommentInfo__name",children:e}),V.jsx("p",{className:"CommentInfo__email",children:t}),V.jsx("p",{className:"CommentInfo__body",children:i})]}),Lc=({comments:e})=>V.jsx("div",{className:"comments",children:e.map(t=>V.jsx(Pc,{comment:t},t.id))}),Tc=({user:e})=>V.jsxs("div",{className:"user-info",children:[V.jsx("p",{children:e.name}),V.jsx("p",{children:e.email})]}),Mc=({post:e})=>V.jsxs("div",{className:"post",children:[V.jsxs("h2",{children:[" ",e.title," "]}),V.jsx("p",{children:e.body}),V.jsx(Tc,{user:e.user}),e.comments.length!==0?V.jsx(Lc,{comments:e.comments}):V.jsx("p",{children:"No comments yet"})]}),Rc=({posts:e})=>V.jsx("div",{className:"posts",children:e.map(t=>V.jsx(Mc,{post:t},t.id))}),Dc=()=>{const e=Cc.map(t=>({...t,user:Nc.find(i=>i.id===t.userId),comments:zc.filter(i=>i.postId===t.id)}));return V.jsxs("section",{className:"App",children:[V.jsx("h1",{className:"App__title",children:"Static list of posts"}),V.jsx(Rc,{posts:e})]})};em(document.getElementById("root")).render(V.jsx(Dc,{}));
